...
include("BibliotecaInterface.php");
...
$_LEITOR3 = new LeitorInt();
$_LEITOR3->nome = "Cleiton";
$_LEITOR3->tipo = "Leitor";
$_LEITOR3->email = "cleiton@ftec.com";
$_LEITOR3->login = "clt";
$_LEITOR3->senha = "cleitin";

$_LEITOR3->verLivros($vet);
